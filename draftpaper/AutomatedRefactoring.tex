...
\begin{figure}[t]
	...
	\caption{Refactoring process in general \cite{DBLP:conf/iwpse/MensTM03}}
	\label{fig:process}
\end{figure}
...
Mens et al.\ identify three steps in the refactoring process \cite{DBLP:conf/iwpse/MensTM03} which are also illustrated in \autoref{fig:process}:
\begin{enumerate}
