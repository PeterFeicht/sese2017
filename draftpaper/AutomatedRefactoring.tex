...
\section{Automated Refactoring in General}\label{sect:general}

The investigation of some contributions to automated refactoring, as described in \autoref{sect:approaches}, has shown us that the spectrum of automated refactoring is quite wide. Different 
...
\section{Automated Refactoring Approaches}\label{sect:approaches}
...
\subsubsection{JDEvAn}\label{sect:JDEvAn}
...
\subsubsection{Code-Imp}\label{sect:Code-Imp}
...
We compared the approaches defined in \autoref{sect:approaches} with respect to the main refactoring goals and refactoring steps defined in \autoref{sect:general}. This showed us some similarities and differences, or the advantages and disadvantages of the respective approaches, which are described in \autoref{sect:results} and summarized in tables \ref{tbl:goals} and \ref{tbl:steps}.

\subsubsection{Similarities and differences}\label{sect:results}
...
JDEvAn (\autoref{sect:JDEvAn}) and Code-Imp (\autoref{sect:Code-Imp}) both provide a fully automated solution for refactoring using Design Differencing. However, as here the designs are extracted from the source code, the correctness cannot be guaranteed.
