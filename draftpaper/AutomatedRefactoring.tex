...
changing its state dynamically it can be refactored by introducing a state object \cite{designpatter}.
...
Code-Imp (Combinatorial Optimization for Design Improvement) \cite{2008502, 5313}.
...
\cite{Xing:2006:RDB:1174510.1174736}.
...
Code-Imp is developed by \cite{2008502, 5313, bibid} as a fully automated refactoring framework for automatically 
improving the design of existing programs. It takes Java source code as input and provides a refactored version of the 
program as output.
