...
Mens et al.\ identify three steps in the refactoring process \cite{DBLP:conf/iwpse/MensTM03}:
\begin{enumerate}
...
smells}, symptoms of poor design and implementation choices \cite{DBLP:books/daglib/0019908}.
